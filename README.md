...
| タイプ             | タイトル         | 解説メッセージ（回答文）                                                                                                                                                           |
| ------------------ | ---------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 理論重視型         | 理論重視型       | 「なぜ？」を解決することがやる気の源泉です。全体像を把握し、納得してから進むことで驚異的な理解力を発揮します。論理的なつながりが見えた時、あなたの学習スピードは最大化されます。   |
| 実践重視型         | 実践重視型       | 考えてから動くより、動いてから考える方が得意なタイプ。まずは手を動かし、小さな失敗を積み重ねるのが一番の近道です。理論は後からついてくる、というスタンスがあなたには合っています。 |
| コツコツ型         | コツコツ型       | 継続こそが最大の武器。派手な一歩よりも、昨日の自分を超える数ミリの積み重ねが自信に繋がります。最終的に誰よりも高い場所に到達できる、圧倒的な安定感の持ち主です。                   |
| 短期集中型         | 短期集中型       | 集中した時の密度はピカイチ。スイッチが入った時に一気に進め、無理に分散させず「今はこれ！」と決めて没頭するのが吉です。短時間で本質を掴み取る、瞬発力のある学習スタイルです。       |
...
Google StitchでManusで作成したイラストを参考に作成
